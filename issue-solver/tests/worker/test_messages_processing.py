from issue_solver.worker.messages_processing import sanitize_branch_name


class TestSanitizeBranchName:
    """Test cases for Git branch name sanitization."""
    ...
    def test_sanitize_basic_valid_name(self):
    ...
    def test_sanitize_spaces_replaced(self):
        ...
        assert (
            sanitize_branch_name("fix authentication bug") == "fix-authentication-bug"
        )
    ...
    def test_sanitize_special_characters(self):
        ...
        assert (
            sanitize_branch_name("Feature [new] component") == "Feature-new-component"
        )
    ...
    def test_sanitize_consecutive_separators(self):
        ...
        assert (
            sanitize_branch_name("fix__double__underscore") == "fix-double-underscore"
        )
        assert sanitize_branch_name("fix-.-_mixed") == "fix-mixed"

    def test_sanitize_leading_trailing_invalid_chars(self):
    ...
    def test_sanitize_length_truncation_with_trailing_chars(self):
