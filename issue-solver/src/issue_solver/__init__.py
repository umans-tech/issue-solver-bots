...
from issue_solver.start_resolution import SolveIssueCommand, AgentModel, AgentName, IssueDescription


def main() -> None:
    print("Hello from issue-solver!")

def prepare_solve_issue(generate_patch: Callable[[SolveIssueCommand], None]) -> Callable[[], None]:
