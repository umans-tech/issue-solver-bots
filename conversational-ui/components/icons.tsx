...
export const GitIcon = ({ 
  ...
  provider?: 'git' | 'github' | 'gitlab' | 'azure' | 'bitbucket'
}) => {
  ...
  useEffect(() => {
    console.log(`GitIcon status: ${status}, provider: ${provider}`);
  }, [status, provider]);

  // Create a generic Git icon (different from GitHub)
  const renderGitIcon = () => (
    <svg
      height="16"
      width="16"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.698 7.28L8.72 0.302C8.6 0.182 8.44 0.115 8.272 0.115C8.104 0.115 7.944 0.182 7.823 0.302L6.282 1.844L8.224 3.785C8.434 3.724 8.655 3.72 8.867 3.773C9.079 3.826 9.273 3.934 9.428 4.089C9.583 4.243 9.691 4.437 9.744 4.65C9.797 4.862 9.794 5.083 9.735 5.293L11.598 7.155C11.808 7.095 12.029 7.092 12.241 7.145C12.453 7.198 12.647 7.306 12.803 7.46C12.871 7.529 12.926 7.609 12.966 7.696C13.006 7.784 13.03 7.879 13.038 7.975C13.046 8.071 13.037 8.168 13.012 8.261C12.987 8.354 12.946 8.441 12.891 8.519C12.837 8.597 12.769 8.663 12.692 8.716C12.614 8.769 12.526 8.807 12.434 8.829C12.341 8.851 12.244 8.857 12.148 8.846C12.052 8.835 11.959 8.808 11.872 8.765C11.786 8.723 11.707 8.666 11.639 8.596C11.471 8.428 11.365 8.215 11.332 7.985C11.299 7.756 11.343 7.522 11.457 7.32L9.68 5.543V9.451C9.779 9.5 9.866 9.566 9.935 9.644C10.101 9.81 10.206 10.021 10.239 10.248C10.272 10.476 10.232 10.708 10.124 10.91C10.016 11.113 9.846 11.277 9.64 11.377C9.434 11.478 9.201 11.509 8.975 11.467C8.75 11.425 8.544 11.312 8.387 11.145C8.207 10.965 8.098 10.733 8.078 10.485C8.058 10.237 8.129 9.991 8.278 9.786V5.464C8.129 5.26 8.058 5.014 8.077 4.766C8.097 4.518 8.205 4.285 8.383 4.105L6.468 2.19L0.302 8.357C0.242 8.417 0.195 8.488 0.163 8.566C0.131 8.644 0.115 8.728 0.115 8.812C0.115 8.897 0.131 8.98 0.163 9.059C0.195 9.137 0.242 9.208 0.302 9.268L7.28 16.245C7.34 16.305 7.411 16.353 7.489 16.386C7.568 16.418 7.651 16.435 7.735 16.435C7.82 16.435 7.903 16.418 7.982 16.386C8.06 16.353 8.131 16.305 8.191 16.245L15.698 8.739C15.818 8.618 15.885 8.458 15.885 8.29C15.885 8.123 15.818 7.962 15.698 7.842V7.28Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  const renderAzureIcon = () => (
    ...
    >
      <path
        d="M0 5.79977V12.9998C0 13.4142 0.335786 13.7498 0.75 13.7498H1.93396L7.38434 8.37305C7.7513 8.01218 8.35445 8.01218 8.72141 8.37305L14.137 13.7152C14.3256 13.9002 14.5821 14.0002 14.8504 14.0002H15.25C15.6642 14.0002 16 13.6642 16 13.25V2.75023C16 2.33601 15.6642 2.00023 15.25 2.00023H0.75C0.335786 2.00023 0 2.33601 0 2.75023V5.79977ZM8.06 11.3499L12.5 7L15.25 9.65991V2.75023H0.75V11.3499H8.06Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  const renderBitbucketIcon = () => (
    ...
    >
      <path
        d="M1.16989 0.0553548C0.933018 0.0553548 0.728031 0.1748 0.608156 0.392844C0.485908 0.612478 0.464583 0.886297 0.546963 1.1288L2.77362 9.99926C2.89883 10.4221 3.27468 10.7186 3.71015 10.7186H12.3279C12.6518 10.7186 12.9374 10.4976 13.0199 10.185L15.2466 1.12964C15.329 0.886297 15.3061 0.613348 15.185 0.393714C15.0639 0.1748 14.8589 0.0553548 14.6231 0.0553548H1.16989ZM9.27881 7.13343H6.71035L5.97446 2.92232H10.0391L9.27881 7.13343Z"
        fill="currentColor"
      />
      <path
        d="M14.2024 13.6064H10.1617L9.81078 15.3467C9.771 15.5458 9.60168 15.6913 9.39932 15.6913H6.54625C6.42191 15.6913 6.29931 15.6362 6.21874 15.5346C6.13903 15.4347 6.1071 15.2996 6.13729 15.1769L6.5025 13.1642C6.54976 12.947 6.73869 12.7807 6.96066 12.7807H14.6489C14.7891 12.7807 14.9223 12.847 15.0041 12.9583C15.086 13.0697 15.1088 13.2153 15.0644 13.3466L14.8015 14.1868C14.7309 14.4432 14.4879 14.6179 14.2024 14.6179V13.6064Z"
        fill="currentColor"
      />
    </svg>
  );

  // Determine which icon to render based on provider
  const renderIcon = () => {
    switch (provider) {
      case 'github':
        return renderGithubIcon();
      case 'gitlab':
        return renderGitlabIcon();
      case 'azure':
        return renderAzureIcon();
      case 'bitbucket':
        return renderBitbucketIcon();
      default:
  ...
  return (
    <div className="relative">
      {/* Main Git icon - based on provider */}
      {renderIcon()}
