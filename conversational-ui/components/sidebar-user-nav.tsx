        ...
        <DropdownMenu>
          ...
          >
            <div className="px-2.5 py-2 text-xs text-muted-foreground flex items-center justify-between">
              <span>Plan</span>
              <span
                className={`rounded-full px-2 py-0.5 text-[10px] font-medium border ${plan === 'free' ? 'bg-muted text-foreground' : 'bg-emerald-600/10 text-emerald-700 dark:text-emerald-300 border-emerald-600/20'}`}
              >
                {plan}
              </span>
            </div>
