          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Account Information:</strong> Name, email address, company name, billing information, and other contact details.</li>
                <li><strong>Client Data:</strong> The data, code, or content you submit to the Services.</li>
                <li><strong>Automatically Collected Data:</strong> Log data, cookies, and usage information.</li>
                <li><strong>Information from Third Parties:</strong> Data received from service providers.</li>
              </ul>
              ...
              <h3 className="text-xl font-semibold">4. Your Rights under GDPR</h3>
